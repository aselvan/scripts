#!/usr/bin/env bash
#
# whois.sh --- parse whois output and print in simple form. 
#
...
#
# Version History:
#   Jul 24, 2023 --- Original version
#   Dec 17, 2024 --- Renamed to whois.sh and added contact info for default run
...
print_domain_info() {
  ...
  abuse_email=$(grep 'Registrar Abuse Contact Email:' $whois_file | cut -d: -f2-)
  abuse_phone=$(grep 'Registrar Abuse Contact Phone:' $whois_file | cut -d: -f2-)
